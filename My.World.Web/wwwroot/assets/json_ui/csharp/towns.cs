...
//    using QuickType;
//
//    var towns = Towns.FromJson(jsonString);
...
namespace QuickType
{
    ...
    public partial class Towns
    {
        ...
        public Culture Populace { get; set; }

        [JsonProperty("sustainability")]
        public History Sustainability { get; set; }
    }
    ...
    public partial class Towns
    {
        public static Towns FromJson(string json) => JsonConvert.DeserializeObject<Towns>(json, QuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Towns self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
    }
