...
{
	public class LoresViewModel
	{
		[JsonProperty("loresmodel")]
		public LoresModel loresModel { get; set; }
		...
		public LoresViewModel(IObjectBucketApiService _iObjectBucketApiService)
		{
