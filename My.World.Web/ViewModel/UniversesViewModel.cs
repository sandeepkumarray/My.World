...
{
	public class UniversesViewModel
	{
		[JsonProperty("universesmodel")]
		public UniversesModel universesModel { get; set; }
		...
		public UniversesViewModel()
		{
		}

		public UniversesViewModel(IObjectBucketApiService _iObjectBucketApiService)
		{
