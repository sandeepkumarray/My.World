...
{
	public class TraditionsViewModel
	{
		[JsonProperty("traditionsmodel")]
		public TraditionsModel traditionsModel { get; set; }
		...
		public TraditionsViewModel(IObjectBucketApiService _iObjectBucketApiService)
		{
