...
namespace My.World.Web.ViewModel
{
	...
	{
		[JsonProperty("organizationsmodel")]
		public OrganizationsModel organizationsModel { get; set; }
		...
		public OrganizationsViewModel(IObjectBucketApiService _iObjectBucketApiService)
		{
