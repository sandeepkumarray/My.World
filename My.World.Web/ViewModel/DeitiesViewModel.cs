...
{
	public class DeitiesViewModel
	{
		[JsonProperty("deitiesmodel")]
		public DeitiesModel deitiesModel { get; set; }
		...
		public DeitiesViewModel()
		{
		}

		public DeitiesViewModel(IObjectBucketApiService _iObjectBucketApiService)
		{
