...
{
	public class GovernmentsViewModel
	{
		[JsonProperty("governmentsmodel")]
		public GovernmentsModel governmentsModel { get; set; }
		...
		public GovernmentsViewModel()
		{
		}

		public GovernmentsViewModel(IObjectBucketApiService _iObjectBucketApiService)
		{
