...
namespace My.World.Web.ViewModel
{
	...
	{
		[JsonProperty("technologiesmodel")]
		public TechnologiesModel technologiesModel { get; set; }
		...
		public TechnologiesViewModel(IObjectBucketApiService _iObjectBucketApiService)
		{
