...
namespace My.World.Web.ViewModel
{
	...
	{
		[JsonProperty("religionsmodel")]
		public ReligionsModel religionsModel { get; set; }
		...
		public ReligionsViewModel()
		{
		}

		public ReligionsViewModel(IObjectBucketApiService _iObjectBucketApiService)
		{
