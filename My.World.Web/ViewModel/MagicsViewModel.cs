...
{
	public class MagicsViewModel
	{
		[JsonProperty("magicsmodel")]
		public MagicsModel magicsModel { get; set; }
		...
		public MagicsViewModel()
		{
		}

		public MagicsViewModel(IObjectBucketApiService _iObjectBucketApiService)
		{
