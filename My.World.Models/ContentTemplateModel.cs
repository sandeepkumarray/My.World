...
{
    public class ContentTemplateModel : BaseModel
    {
        public ContentTemplateModel()
        {
    ...
    public partial class Attribute
    {
        ...
        public Attribute(string _field_name, string _field_label, string _field_type, string _help_text, bool _auto_increament, bool _allow_null = true, bool _is_active = true, bool _is_hidden = false, bool _is_user_defined = false)
        {
